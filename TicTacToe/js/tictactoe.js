...
let activePlayer = "X";
//This array stores an array of moves. We use this to determine win condtitions.
let selectedSquares = [];

//This function is for placing an x or o in a square.
function placeXOrO(squareNumber) {
    //This condition ensures a square hasn't been selected already.
    //The .some() method is used to check each element of seelectedSquare array
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if(activePlayer === 'X') {
         ...
         if(activePlayer === 'X'){
             ...
             activePlayer = 'O';
             //If active olayer is anything other than 'X'.
         } else {
    ...
    //This functino results in a random square being selected.
...
//This line accesses our html canvas element.
    ...
    let x1 = coordX1, 
        ...
        x = x1,
        //This variable stores temporary y axis data we update in our aninimation loop.
        y = y1;
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (x < x2) { x += 10; }
            //This condition adds 10 to the prevous end y point.
            if (y < y2) { y += 10; }
    ...
    //This function clears our canvas after or win line is drawn. 
    function clear() {
